...
export default function AboutRightSection({ posts, activeSection }: Props) {
    return (
        <div className="flex flex-col justify-start bg-[#0E0B14] lg:pl-10 lg:py-10 lg:gap-32 px-5 mx-auto gap-16">
            <div id="about">
                <h2 className={`m-0 w-full text-[#E8E4EF] font-bold text-2xl pb-4 lg:hidden ${activeSection == "#about" ? "sticky top-0 backdrop-blur-sm" : ""}`}>About</h2>
                <AboutRightSectionText />
            </div>
            <div id="experience" className="flex flex-col lg:gap-3 gap-4">
                <h2 className={`text-[#E8E4EF] font-bold text-2xl pb-4 lg:hidden ${activeSection == "#experience" ? "sticky top-0 backdrop-blur-sm" : ""}`}>Experience</h2>
            ...
            <div id="projects" className="flex flex-col lg:gap-3 gap-6">
                <h2 className={`text-[#E8E4EF] font-bold text-2xl pb-4 lg:hidden ${activeSection == "#projects" ? "sticky top-0 backdrop-blur-sm" : ""}`}>Projects</h2>
            ...
            <div id="blog" className="lg:mb-8 mb-16">
                <h2 className={`text-[#E8E4EF] font-bold text-2xl pb-4 lg:hidden ${activeSection == "#blog" ? "sticky top-0 backdrop-blur-sm" : ""}`}>Blog</h2>
                {posts.map((post) => (
