...
export default function ExperienceCard({ duration, company, position, description, technologies = [] }: Props) {
    return (
        <div className="flex lg:flex-row flex-col text-textColor lg:gap-4 lg:shadow-md lg:p-4 rounded-lg lg:hover:bg-[#1d172a] hover:border-accentColor transition duration-500 ease-in-out py-1">
