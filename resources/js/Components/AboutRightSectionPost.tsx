...
export default function AboutRightSectionPost({ post }: Props) {
    ...
    return (
        <a href={`/posts/${post.id}`} className="w-full">
            <div className="flex flex-row text-[#e8e4ef] gap-4 shadow-md rounded-lg px-2 hover:bg-[#1d172a] hover:border-[#8567c2] transition duration-500 ease-in-out align-baseline leading-none whitespace-nowrap py-8">
