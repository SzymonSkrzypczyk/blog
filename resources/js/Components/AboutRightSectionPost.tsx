...
export default function AboutRightSectionPost({ post }: Props) {
    ...
    return (
        <a href={`/posts/${post.id}`} className="w-full">
            <div className="flex flex-row text-textColor gap-4 shadow-md rounded-lg lg:px-2 lg:hover:bg-[#1d172a] lg:hover:border-[#8567c2] transition duration-500 ease-in-out align-baseline leading-none py-8">
